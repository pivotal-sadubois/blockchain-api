...
```json
{
  ...
  "apiOwner" : "",
  "apiSystem" : "",
  "artifactId" : "blockchain-api",
  "buildTool" : "maven",
  "databaseMigrationTool" : "flyway",
  "databaseName" : "blockchain-database",
  "exposeOpenAPIEndpoint" : true,
  "groupId" : "com.vmware.tanzu",
  "javaVersion" : "17",
  "liveUpdateIDESupport" : true,
  "packageName" : "tanzu.blockchain",
  "projectName" : "blockchain-api",
  "sourceRepositoryPrefix" : "nitashav.azurecr.io/tap-dev/blockchain-api-source"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol packageDirectory with value 'tanzu/blockchain'
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'blockchain-api'
┃ ┃ ┃ Debug Adding symbol databaseResourceName with value 'blockchain-database'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [rest-service-db->blockchain-api]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [customer-profile-database->blockchain-database]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [customerprofiledatabase->blockchain-database]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->blockchain-api]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [dev.local->nitashav.azurecr.io/...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [com.vmware.tap.accelerators.restservicedb->tanzu.blockchain]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/data/CustomerProfileRepository.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/Application.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/ApplicationTests.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileService.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/data/CustomerProfileEntity.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/api/CustomerProfileController.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/data/CustomerProfileRepository.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/Application.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/ApplicationTests.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileService.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/data/CustomerProfileEntity.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/api/CustomerProfileController.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/domain/CustomerProfileServiceTest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/data/CustomerProfileRepository.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/api/CustomerProfileControllerTest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileResponse.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/Application.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/ApplicationTests.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileService.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/data/CustomerProfileEntity.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/main/java/tanzu/blockchain/domain/CustomerProfileCreateRequest.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/test/java/tanzu/blockchain/data/CustomerProfileRepositoryTest.java didn't match [manifest.yaml] -> included
...
┃ ┗ ┗ ┗ ┗ Debug src/main/java/tanzu/blockchain/api/CustomerProfileController.java didn't match [manifest.yaml] -> included
